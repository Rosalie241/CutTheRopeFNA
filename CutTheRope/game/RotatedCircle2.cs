	...
	internal class RotatedCircle2 : BaseElement
	{
		...
		public override NSObject init()
		{
			if (base.init() != null)
			{
				...
				vinilBL = Image.Image_createWithResIDQuad(IMG_OBJ_VINIL, 0);
				vinilBL.anchor = 12;
				vinilBR = Image.Image_createWithResIDQuad(IMG_OBJ_VINIL, 0);
				vinilBR.scaleX = -1f;
				vinilBR.anchor = 9;
				vinilTL = Image.Image_createWithResIDQuad(IMG_OBJ_VINIL, 0);
				vinilTL.scaleY = -1f;
				vinilTL.anchor = 36;
				vinilTR = Image.Image_createWithResIDQuad(IMG_OBJ_VINIL, 0);
		...
		public virtual NSObject copy()
		{
			...
			rotatedCircle.handle1 = MathHelper.vectRotateAround(rotatedCircle.handle1, MathHelper.DEGREES_TO_RADIANS(rotatedCircle.rotation), rotatedCircle.x, rotatedCircle.y);
			rotatedCircle.handle2 = MathHelper.vectRotateAround(rotatedCircle.handle2, MathHelper.DEGREES_TO_RADIANS(rotatedCircle.rotation), rotatedCircle.x, rotatedCircle.y);
