...
namespace CutTheRope.game
{
	internal class RotatedCircle : BaseElement
	{
		...
		public virtual NSObject copy()
		{
			...
			rotatedCircle.handle1 = MathHelper.vect(rotatedCircle.x - FrameworkTypes.RTPD(size * 3f), rotatedCircle.y);
			rotatedCircle.handle2 = MathHelper.vect(rotatedCircle.x + FrameworkTypes.RTPD(size * 3f), rotatedCircle.y);
